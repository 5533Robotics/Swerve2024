...
class TunerConstants:
    ...
    _front_left_encoder_offset: units.rotation = 0.187255859375
    _front_left_steer_motor_inverted = True
    _front_left_cancoder_inverted = False

    _front_left_x_pos: units.meter = inchesToMeters(9.4375)
    _front_left_y_pos: units.meter = inchesToMeters(9.9375)

    # Front Right
    _front_right_drive_motor_id = 7
    _front_right_steer_motor_id = 3
    _front_right_encoder_id = 11
    _front_right_encoder_offset: units.rotation = 0.41162109375
    _front_right_steer_motor_inverted = True
    _front_right_cancoder_inverted = False

    _front_right_x_pos: units.meter = inchesToMeters(9.4375)
    _front_right_y_pos: units.meter = inchesToMeters(-9.9375)

    # Back Left
    _back_left_drive_motor_id = 6
    _back_left_steer_motor_id = 0
    _back_left_encoder_id = 9
    _back_left_encoder_offset: units.rotation = 0.37451171875
    _back_left_steer_motor_inverted = True
    _back_left_cancoder_inverted = False

    _back_left_x_pos: units.meter = inchesToMeters(-9.4375)
    _back_left_y_pos: units.meter = inchesToMeters(9.9375)

    # Back Right
    _back_right_drive_motor_id = 4
    _back_right_steer_motor_id = 5
    _back_right_encoder_id = 10
    _back_right_encoder_offset: units.rotation = 0.024658203125
    _back_right_steer_motor_inverted = True
    _back_right_cancoder_inverted = False

    _back_right_x_pos: units.meter = inchesToMeters(-9.4375)
    _back_right_y_pos: units.meter = inchesToMeters(-9.9375)
